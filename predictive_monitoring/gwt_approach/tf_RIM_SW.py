'''
Tensorflow implementation of Recurrent Independent Mechanisms from https://github.com/fuyuan-li/tensorflow-RIMs
'''
...
# TODO https://github.com/L0SG/relational-rnn-pytorch/blob/master/relational_rnn_models.py in tensorflow
...
class RIMCell(tf.keras.layers.Layer):
    ...
    def sw_broadcast(self, h_new, mask, training=False):
        bc_key_layer = self.key_(h_new)
        # bc_value_lay
